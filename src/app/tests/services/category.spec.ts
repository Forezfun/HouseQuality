...
import { CategoryService } from "../../client-side/services/category.service";
...
describe('CategoryService ', () => {
    ...
    describe('getAllCategories', () => {
        ...
        it('should return category array', async () => {
            ...
            expect(httpMock.get).toHaveBeenCalledOnceWith(BASE + 'all');
        });
        ...
        it('should handle server error response', async () => {
            ...
            try {
                ...
                if (error instanceof HttpErrorResponse) {
                    expect(error.message).toBe('Http failure response for ' + BASE + 'all: 500 Server Error');
